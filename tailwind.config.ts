...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'gradient-gaming': 'linear-gradient(135deg, #ff6b35 0%, #f7931e 50%, #ff6b35 100%)',
				'gradient-gaming-hover': 'linear-gradient(135deg, #ff5722 0%, #ff9800 50%, #ff5722 100%)',
				'gradient-dark': 'var(--gradient-dark)',
				'gradient-glow': 'var(--gradient-glow)',
			},
			boxShadow: {
				'neon-orange': '0 0 20px rgba(255, 107, 53, 0.5), 0 0 40px rgba(255, 107, 53, 0.3)',
				'neon-orange-hover': '0 0 30px rgba(255, 107, 53, 0.7), 0 0 60px rgba(255, 107, 53, 0.5)',
